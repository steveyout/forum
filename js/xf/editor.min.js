...
function k(){XF.EditorHelpers.isPreviewAvailable(e(a.$oel))&&(XF.EditorHelpers.sync(a),e(a.$oel).val()&&(l?g():h()))}function m(){var b=a.$tb.find(".fr-btn-grp");XF.EditorHelpers.isPreviewAvailable(e(a.$oel))?(b.slice(b.length-1).addClass("rte-tab--inactive rte-tab--preview"),b.slice(b.length-2,b.length-1).addClass("rte-tab--beforePreview")):b.slice(b.length-1).addClass("rte-tab--beforePreview")}var l=!1;return{_init:function(){a.events.on("buttons.refresh",function(){return!l});m();a.events.on("codeView.toggle",
