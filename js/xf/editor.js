	...
	XF.Editor = XF.Element.newHandler({
		...
		getEditorConfig: function()
		{
			...
			var config = {
				...
				htmlAllowedTags: ['a', 'audio', 'b', 'bdi', 'bdo', 'blockquote', 'br', 'cite', 'code', 'dfn', 'div', 'em', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'hr', 'i', 'img', 'li', 'mark', 'ol', 'p', 'pre', 's', 'script', 'style', 'small', 'span', 'strike', 'strong', 'sub', 'sup', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'time', 'tr', 'u', 'ul', 'var', 'video', 'wbr'],
		...
		registerCommands: function()
		{
			...
			FroalaEditor.PLUGINS.xfInsertGif = function(editor)
			{
				...
				function showMenu()
				{
					...
					var $btn = $(editor.$tb.find('.fr-command[data-cmd="xfInsertGif"]'));
