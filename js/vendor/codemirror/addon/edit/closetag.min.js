...
var d=Math.min(a.lastLine()+1,f.line+500);f=g.scanForClosingTag(a,f,null,d);if(!f||f.tag!=c)return!1;k=k?1:0;for(var b=e.length-1;0<=b;b--)if(e[b]==c)++k;else break;f=f.to;for(b=1;b<k;b++){e=g.scanForClosingTag(a,f,null,d);if(!e||e.tag!=c)return!1;f=e.to}return!0}g.defineOption("autoCloseTags",!1,function(a,e,c){c!=g.Init&&c&&a.removeKeyMap("autoCloseTags");if(e){c={name:"autoCloseTags"};if("object"!=typeof e||!1!==e.whenClosing)c["'/'"]=function(a){a=a.getOption("disableInput")?g.Pass:q(a,!0);return a};
if("object"!=typeof e||!1!==e.whenOpening)c["'>'"]=function(a){return v(a)};a.addKeyMap(c)}});var w="area base br col command embed hr img input keygen link meta param source track wbr".split(" "),x="applet blockquote body button div dl fieldset form frameset h1 h2 h3 h4 h5 h6 head html iframe layer legend object ol p select table ul".split(" ");g.commands.closeTag=function(a){return q(a)}});
